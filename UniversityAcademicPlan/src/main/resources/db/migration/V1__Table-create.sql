create table if not exists course (id int8 generated by default as identity, name varchar(255) not null unique, location_id int8 not null, primary key (id));
...
create table if not exists lecture (id int8  generated by default as identity, name varchar(255) not null, course_id int8, primary key (id));
create table if not exists location (id int8 generated by default as identity, name varchar(255) not null unique, primary key (id));
...
create table if not exists stuff (first_name varchar(255) not null, last_name varchar(255) not null, id int8 not null, primary key (id));
...
alter table if exists course_teacher add constraint FK_teacher foreign key (teacher_id) references teacher on delete cascade;
alter table if exists course_teacher add constraint FK_course foreign key (course_id) references course on delete cascade;
alter table if exists groups_course add constraint FK_course foreign key (course_id) references course on delete cascade;
alter table if exists groups_course add constraint FK_groups foreign key (groups_id) references groups on delete cascade;
alter table if exists lecture add constraint FK_course foreign key (course_id) references course on delete cascade;;
...
alter table if exists student_course add constraint FK_course foreign key (course_id) references course on delete cascade;
alter table if exists student_course add constraint FK_student foreign key (student_id) references student on delete cascade;
...
alter table if exists stuff add constraint FK_users foreign key (id) references users;