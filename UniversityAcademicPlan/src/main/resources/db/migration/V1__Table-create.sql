...
create table if not exists users (id int8 generated by default as identity, nick_name varchar(255) not null, password varchar(255) not null, user_type varchar(255) not null, primary key (id));
