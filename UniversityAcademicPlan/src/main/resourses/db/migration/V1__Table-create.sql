create table if not exists course (id int8 generated by default as identity, name varchar(255) not null, location_id int8, primary key (id));
...
create table if not exists lecture (id int8 not null, name varchar(255) not null, course_id int8, primary key (id));
create table if not exists location (id int8 not null, name varchar(255) not null, primary key (id));
create table if not exists schedule (id int8 generated by default as identity, day_of_week varchar(255) not null, end_time time not null, start_time time not null, course_id int8, primary key (id));
...
create table if not exists users (id int8 generated by default as identity, nick_name varchar(255) not null, password varchar(255) not null, user_tipe varchar(255) not null, primary key (id));
